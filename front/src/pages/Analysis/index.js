...
const Page = () => {
    ...
    const [qId, setQId] = useState(query.get('qId') != null ? query.get('qId') : '');
    const [qRevendedor, setQRevendedor] = useState(query.get('qRevendedor') != null ? query.get('qRevendedor') : '');
    const [qApostador, setQApostador] = useState(query.get('qApostador') != null ? query.get('qApostador') : '');
    const [qTelefone, setQTelefone] = useState(query.get('qTelefone') != null ? query.get('qTelefone') : '');
    const [qEndereco, setQEndereco] = useState(query.get('qEndereco') != null ? query.get('qEndereco') : '');
    const [qData, setQData] = useState(query.get('qData') != null ? query.get('qData') : '');
    const [qHora, setQHora] = useState(query.get('qHora') != null ? query.get('qHora') : '');
    ...
    return (
        <PageContainer>
            ...
            <PageArea>
                {!filter &&
                    <Filter onClick={handleFilter}>Mostrar filtros</Filter>
                }
                {filter &&
                    <>
